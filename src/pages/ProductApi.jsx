...
<div className="m-8 flex  gap-2 flex-wrap grid grid-cols-1 md:grid-cols-3 justify-center   dark:bg-gray-800  dark:text-white">


{value.map((item, index) => (
            <>
            
            <div className="m-8  max-w-sm bg-white bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">


    <a href="#">
        <img className=" p-5 h-[200px]	max-h-svh" src={item.image} alt="product image" />
    </a>
    <div className="px-5 pb-5">
        ...
        <div className="flex items-center mt-2.5 mb-5">
            ...
            <span className="bg-blue-100 text-blue-800 tex`t-xs font-semibold px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ms-3">5.0</span>
        </div>
